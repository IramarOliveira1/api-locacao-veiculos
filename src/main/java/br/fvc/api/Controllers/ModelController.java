...
public class ModelController {
    ...
    @PostMapping("/filter")
    public ResponseEntity<Object> filter(@RequestBody() Model model) {
        return modelService.filter(model);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable("id") Long id, @RequestBody Model model) {
