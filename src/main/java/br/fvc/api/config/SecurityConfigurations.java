    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/category/all").hasRole("ADMIN") 
                        .requestMatchers(HttpMethod.POST, "/category/filter").hasRole("ADMIN")                        
                        .requestMatchers(HttpMethod.POST, "/category/register").hasRole("ADMIN") 
